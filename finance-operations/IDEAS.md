1- FWould you like to freeze the top header row programmatically during this ingestion cycle to ensure it always remains visible when scrolling through the newly prepended data
2- plement a schema validation step to ensure the headers match a predefined expected array before executing the deduplication engine
